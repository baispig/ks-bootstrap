...
```bash
curl -fsSLO https://raw.githubusercontent.com/baispig/ks-bootstrap/v0.6.2/bootstrap.sh
curl -fsSLO https://raw.githubusercontent.com/baispig/ks-bootstrap/v0.6.2/SHA256SUMS
