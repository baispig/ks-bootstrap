...
```bash
curl -fsSLO https://raw.githubusercontent.com/baispig/ks-bootstrap/v0.3.2/bootstrap.sh
curl -fsSLO https://raw.githubusercontent.com/baispig/ks-bootstrap/v0.3.2/SHA256SUMS
