...
```bash
curl -fsSLO https://raw.githubusercontent.com/baispig/ks-bootstrap/v0.6.1/bootstrap.sh
curl -fsSLO https://raw.githubusercontent.com/baispig/ks-bootstrap/v0.6.1/SHA256SUMS
